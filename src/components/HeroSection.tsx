...
export function Hero(){
    return (
        <section id="hero" className="flex flex-col [@media(min-width:550px)]:flex-row gap-x-4 justify-center w-full max-w-5xl p-5 mt-19 sm:mt-25 rounded-2xl shadow-primary">
            <div className="flex flex-col items-center w-full h-70 [@media(min-width:550px)]:w-55 p-5 rounded-2xl shadow-primary">
                <img src="/img/foto.webp" alt="foto de user" className="size-35 rounded-full shadow-primary"/>
            ...
            <div className="basis-2/3 flex flex-col max-w-2xl p-3 my-4 text-pretty">
                ...
                <p className="mt-2 text-base md:text-xl">
                    The <span className="font-bold">About Me</span> or Profile section of your portfolio, <strong>is a short summary about yourself in relation</strong> to the type of role you are applying for. Lorem ipsum dolor sit, amet consectetur adipisicing elit. 
                </p>
